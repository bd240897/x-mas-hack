...
if st.button('Predict Price'):
    ...
    # {preds_raw}
    # """)
    inputs = {'bad_to_eat': bad_to_eat, 'little_energy': little_energy, 'rash': rash, 'liquid_poop': liquid_poop, }
    response = requests.post(url="http://localhost:8000/poll/", data=json.dumps(inputs))
